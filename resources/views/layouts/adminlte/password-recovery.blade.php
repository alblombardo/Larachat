...
<head>
    ...
    <title>Medialogic Apps - {{ env('APP_NAME')}} | Recupera la password</title>
...
<div class="login-box">
    ...
    <div class="login-box-body" style="position:relative">
        ...
        <p class="login-box-msg" style="margin-top:50px">Fornisci l'indirizzo email associato all'account.
            Ti sarà inviata una mail con le istruzioni per reimpostare la password.</p>
