<header class="main-header">
    ...
    <a href="#" class="logo">
        ...
        <span class="logo-mini">MA</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>Medialogic Apps</b></span>
    </a>
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    ...
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        ...
                        <img src="{{ @asset('/images/logo_160x160.jpg') }}" class="user-image" alt="User Image">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="{{ route('users::edit',Auth::user()->id) }}" class="btn btn-default btn-flat">Profilo</a>
                            </div>
                            <div class="pull-right">
                                <a href="{{ route('logout') }}"
                                   onclick="event.preventDefault();document.getElementById('logout-form').submit();"
                                   class="btn btn-default btn-flat">Esci</a>
